...
/** @public */
export declare type DigitalPurchaseCheckArgument = Api.GoogleActionsTransactionsV3DigitalPurchaseCheckResult;
/**
 ...
 * @public
 */
export declare class DigitalPurchaseCheck extends SoloHelper<'actions.intent.DIGITAL_PURCHASE_CHECK', Api.GoogleActionsTransactionsV3DigitalPurchaseCheckSpec> {
    /**
