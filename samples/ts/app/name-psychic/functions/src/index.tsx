...
const locationResponse = (city: string, speech: string) => {
...
interface ConvData {
  requestedPermission?: GoogleActionsV2UserPermissions
}
...
const coordinatesToCity = (latitude: number, longitude: number): Promise<string> => {
...
app.intent<PermissionArgument>('handle_permission', async (conv, params, permissionGranted) => {
